...
(function () {
  ...
  window.FM = {
    ...
    PARTNERS: [
      ...
      { f: 'cobelfret.jpg', n: 'Cobelfret', h: 34 },
      { f: 'executive-ship-management.png', n: 'Executive Ship Management', h: 30 },
      { f: 'meiji-mms.png', n: 'Meiji Shipping Group', h: 34 },
  ...
  FM.TRACKS = [
    { color: '#6B5FD9', ic: I.lowcode, t: 'Subscribe to the FrontM Operating Platform',
      ...
      cta: 'Explore Platform Plans', route: 'pricing' },
    { color: '#01B3F6', ic: I.ai, t: 'Build maritime digital solutions faster',
      ...
      cta: 'Build with frontm.ai', route: 'frontm-ai' },
    { color: '#18C95C', ic: NI.storefront, t: 'Integrate into the Maritime App Marketplace',
      ...
      cta: 'Join the Marketplace', route: 'marketplace' }
  ];
